...
from db.models import (
    Base, Tier, CurvaMestra, Classe, TalentoClasse, HabilidadeAtiva, Arma, Armadura,
    Consumivel, Monstro, Missao, Material, Magia, Local, Receita, Titulo, Narrativa,
    Faccao, Cidade, NPC, EventoViagem, Player, PlayerInventario,
    PlayerQuest, PlayerReceita, PlayerMutacao, DebuffDerrota,
)
import re
...
def importar():
    ...
    tabelas_e_dados = [
        ...
        (Armadura, "armaduras"), (Consumivel, "consumiveis"), (Monstro, "bestiario"), (Classe, "classes"),
        (HabilidadeAtiva, "habilidades_ativas"),
        ...
        (EventoViagem, "eventos_viagem"), (DebuffDerrota, "debuffs_derrota"),
    ]
